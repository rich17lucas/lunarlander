...
LANDER_COLOR = (0, 255, 255)
PLATFORM_COLOR = (0, 0, 255)
WALL_COLOR = (255, 0, 0)

FONT = pygame.font.SysFont('monospace', 15 * SCALE)
...
class Lander:
    def __init__(self, isAlive=True, pos=Vec2d(0, 0), vel=Vec2d(0, 0)):
        ...
        self.vel = vel
        self.acc = Vec2d(0, 0)
        self.pRect = ScalableRect(self.pos.x, self.pos.y, 20, 20)
...
class Wall:
    def __init__(self, bounds=ScalableRect(0, 0, 1, 1)):
        self.bounds = bounds
...
def update_screen():
    ...
    if DONE:
        if PLAYER_WIN:
            ...
            WINDOW.blit(YOU_LOSE_LABEL, (250, 200 * SCALE))
        WINDOW.blit(REPLAY_LABEL, (250, 215 * SCALE))
